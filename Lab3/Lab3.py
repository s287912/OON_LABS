...
class Node(object):
    ...
    def propagate(self, signal_information):
        ...
        if len(path) > 1:
            line_label = path[:2]
#            print('Linelabel:',line_label)
#            print('Prev:',signal_information.path)
            line = self.successive[line_label]
            signal_information.next()
#           print('Next:',signal_information.path)
...
#        print(path)
#        print(signal_information.latency)
#        print(signal_information.noise_power)
df['path'] = paths
df['latency'] = latencies
df['noises'] = noises
df['snr'] = snrs
#print("successive for node: ",network.nodes['A'].successive)
#print("successive for line: ",network.lines['AB'].successive)
print(df)
network.draw
